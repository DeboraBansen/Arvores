...
int main() {
    ...
    //Implemente um algoritmo que visite todos os nós de uma árvore binária com uma busca em profundidade in-order, pre-order e pos-order. Exemplo, para a árvore abaixo a saída deve ser:Pre-order: 4, 2, 1, 3, 8, 6, 5, 7, 9 In-order: 1, 2, 3, 4, 5, 6, 7, 8, 9 Pos-order: 1, 3, 2, 5, 7, 6, 9, 8, 4
