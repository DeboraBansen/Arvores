//Uma árvore unival (valor universal) é uma árvore na qual todos os nós abaixo dela possuem o mesmo valor. 
//Dada a raiz de uma árvore binária, conte o número de subárvores unival.
...
int main() {
    ...
    No *no3 = adicionar(a,no1,0);
    
    no1->esquerda = no2;
    no1->direita = no3;

    No *no4 = adicionar(a,no3,1);
    No *no5 = adicionar(a,no3,0);
