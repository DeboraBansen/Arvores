...
int main() {
    ...
    //Dada uma árvore binária, retorne o número de comparações feitas em uma pesquisa binária para localizar um nó dada uma chave de acesso.Exemplo dada a árvore abaixo e a chave de pesquisa 5, a saída esperada é 4
